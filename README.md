About ccsds_ndm-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ccsds_ndm-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11298&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ccsds_ndm-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ccsds_ndm` can be installed with `conda`:
...
```
mamba install ccsds_ndm
```

It is possible to list all of the versions of `ccsds_ndm` available on your platform with `conda`:
...
```
mamba search ccsds_ndm --channel conda-forge
```
...
mamba repoquery search ccsds_ndm --channel conda-forge

# List packages depending on `ccsds_ndm`:
mamba repoquery whoneeds ccsds_ndm --channel conda-forge

# List dependencies of `ccsds_ndm`:
mamba repoquery depends ccsds_ndm --channel conda-forge
```
